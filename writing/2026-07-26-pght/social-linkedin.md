...
What they publish is a minefield: 
- prices filed for services a hospital doesn't provide
- placeholder rates CMS had to ban
...
None of this is visible in the software. The only evidence is the things that are not wrong.
